...
for i, j in enumerate(rows):
    if rlc_event_1[i] != "":
        ...
        if rlc_event_1_team_members[i] != "":
            ...
            full_name = first_names[i].lower().strip() + " " + last_names[i].lower().strip()
    ...
    if rlc_event_2[i] != "":
        if rlc_event_2_team_members[i] != "":
            ...
            #check if full name is not in the team members list
            if first_names[i].lower().strip() + " " + last_names[i].lower().strip() not in rlc_event_2_team_members[i]:
                rlc_event_2_team_members[i].append(first_names[i].lower().strip() + " " + last_names[i].lower().strip())
